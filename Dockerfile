...
ENV RAILS_ROOT /opt/members-prototype-integration
...
RUN cd $RAILS_ROOT && gem install bundler && bundle update && env NOKOGIRI_USE_SYSTEM_LIBRARIES=true bundle install \
